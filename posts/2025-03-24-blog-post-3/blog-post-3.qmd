...
## Data for Equity
Please read this article on Data for Equity Principals. While all aspects of this are not relevant for your projects, and the relevance may vary depending on your chosen data sets, there are some important things to think about in general about collecting and working with data.
...
Think about how the principles for advancing equitable data practice are relevant to your data. I realize that many of the principles require interaction with communities, but think about how the principles could be applied if possible. For two or three of the principles, write about how they are relevant and what adhering to the practice would entail for your data. A particularly important principle is transparency. Think about what might be some limitations of your analysis and the potential for abuse or misuse of the data.
Principles: 
